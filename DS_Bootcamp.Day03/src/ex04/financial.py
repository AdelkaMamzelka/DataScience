...
#используй в терминале: 
# 1) python3 -m cProfile -s time financial.py > profiling-sleep.txt 'MSFT' 'Total Revenue'
# 2) python3 -m cProfile -s time financial.py > profiling-tottime.txt 'MSFT' 'Total Revenue' (убрать тайм слип)
